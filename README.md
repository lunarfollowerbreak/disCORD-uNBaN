...
> Если вы наткнулись на что-то вне репозитория `lunarfollowerbreak/disCORD-uNBaN`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/lunarfollowerbreak/disCORD-uNBaN/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/lunarfollowerbreak/disCORD-uNBaN/issues/522)
...
- См. [#765](https://github.com/lunarfollowerbreak/disCORD-uNBaN/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/lunarfollowerbreak/disCORD-uNBaN/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/lunarfollowerbreak/disCORD-uNBaN/discussions/251)
...
- См. также [#252](https://github.com/lunarfollowerbreak/disCORD-uNBaN/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/lunarfollowerbreak/disCORD-uNBaN/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/lunarfollowerbreak/disCORD-uNBaN/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/lunarfollowerbreak/disCORD-uNBaN/blob/main/LICENSE.txt)
